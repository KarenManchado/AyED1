...
int main(){
	...
	cin >> opcion;
	switch(opcion){
		case 1: Mostrar_listado(lista); break;
		case 2: insertar_alumno(lista); break;
		case 3: cout << "Ingrese el nombre del alumno a eliminar: "; cin >> alumno; 
		eliminar_alumno(lista,alumno); break;
		case 4: cout << "Ingrese el nombre del alumno en busqueda: " << endl; cin >> alumno1; buscar_alumno(); break;
		case 0; guardar_archivo(lista); break;
